...
class SimpleFeatureExtractor:
    ...
    def get_features(self, parser_state, **kwargs):
        ...
        ** in function body **
        ...
        features = []
        bufferElem =  parser_state.input_buffer[parser_state.curr_input_buff_idx]
        [second, top] = parser_state.stack_peek_n(2)
        features.append(second.embedding)
        features.append(top.embedding)
        features.append(bufferElem.embedding)
